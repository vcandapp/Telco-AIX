...
This project represents a comprehensive transformation of a telco service provider customer support system, replacing a traditional NLP-based intent classifier with a better & more-capable Generative AI solution. Through systematic fine-tuning, advanced prompt engineering, and deployment on Red Hat OpenShift AI (RHOAI), we achieved **93.95% accuracy** in intent classification, surpassing the legacy system's performance while providing  scalability, multilingual and extend-ability of capabilities.
...
- [Telco-SME Promtp UI & AI Observability](https://github.com/open-experiments/Telco-AIX/tree/main/telco-sme)
